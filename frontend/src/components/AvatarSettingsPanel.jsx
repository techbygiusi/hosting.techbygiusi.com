...
const TEXT = {
  en: {
    ...
    remove: 'Remove',
    hint: 'PNG, JPEG or WebP. The picture is cropped to a square and scaled down to 256 x 256 pixels in your browser before upload.',
  ...
  de: {
    ...
    remove: 'Entfernen',
    hint: 'PNG, JPEG oder WebP. Das Bild wird bereits im Browser quadratisch zugeschnitten und auf 256 x 256 Pixel verkleinert.',

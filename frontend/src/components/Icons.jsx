...
export const SettingsIcon = (props) => (
  <Icon {...props}>
    ...
    <path d="M12 2.7v2.1M12 19.2v2.1M5.4 5.4l1.5 1.5M17.1 17.1l1.5 1.5M2.7 12h2.1M19.2 12h2.1M5.4 18.6l1.5-1.5M17.1 6.9l1.5-1.5" />
    <path d="M9.1 4.3h5.8l.7 1.9 2 1 .4 2.4 1.5 1.4-1.5 1.4-.4 2.4-2 1-.7 1.9H9.1l-.7-1.9-2-1-.4-2.4-1.5-1.4 1.5-1.4.4-2.4 2-1 .7-1.9z" />
  </Icon>
);

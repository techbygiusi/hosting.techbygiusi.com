...
- Open service details, task progress and a full-page browser console with a fixed Nord palette, secure server-side SSH password paste, start controls and automatic reconnect after reboots.
